...
from analysis.analysis import EvaluationScore, EvaluationScoreCI, EvaluationScoreComparison
...
def test_summarize_with_report_urls():
    ...
    report_urls = {
        "agent1_v1": "https://example.com/report/agent1_v1"
    }
